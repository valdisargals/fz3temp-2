...
/* 
768 x 1024 populārais
720 x 1200 mans
710 x 1000 iestatītais
...
<div id="atbildes">
	<div class="atb inactive">
		<div class="bilde">
			<img src="images/<?php echo $pic[0];?>" width="85%">
		</div>
	...
	<div class="atb inactive">
		<div class="bilde">
			<img src="images/<?php echo $pic[1];?>" width="85%">
		</div>
	...
	<div class="atb inactive">
		<div class="bilde">
			<img src="images/<?php echo $pic[2];?>" width="85%">
		</div>
	...
	<div class="atb inactive">
		<div class="bilde">
			<img src="images/<?php echo $pic[3];?>" width="85%">
		</div>
